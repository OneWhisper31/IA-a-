	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 lerpResult21 = lerp( _Color0 , float4( 0,0,0,0 ) , float4( 0,0,0,0 ));
				
				float3 Albedo = _Color1.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = lerpResult21.rgb;
				float3 Specular = 0.5;
				float Metallic = 0.0;
				float Smoothness = _Smoth;
				float Occlusion = 1;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
211;494;1209;505;80.69055;135.4913;1;True;False
Node;AmplifyShaderEditor.ColorNode;20;196.4224,-249.2976;Inherit;False;Property;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.006852974,0.07915403,0.1320755,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;21;510.7879,-147.9459;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;38;415.4343,-429.0845;Inherit;False;Property;_Color1;Color 1;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.3349057,0.8752701,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;611.9623,65.9931;Inherit;False;Constant;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;611.6744,140.3366;Inherit;False;Property;_Smoth;Smoth;0;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=3F2302C94EA7C5C6B2DA3129F7614DDC4EB4E2A9